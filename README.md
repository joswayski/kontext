...
- Kontext API at http://localhost:3001
...
- A fake ride ridesharing application called **Glide** which runs in the background sending and consuming(WIP) messages from the topics above
